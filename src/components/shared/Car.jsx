...
const Card = (props) => {
  ...
  return (
    <div
      className={`lg:col-span-2 fixed top-0 bg-[#1F1D2B] w-full lg:w-96 lg:right-0 h-full transition-all z-50 rounded-xl ${
    ...
    >
      ...
      <div className="relative pt-16 lg:pt-8 text-gray-300 p-8 h-full">
        ...
        <div className="bg-[#1F1D2B] h-[150px] absolute w-full bottom-0 left-0 p-4">
